...
right-click a .cpp file in the Windows Explorer. Clicking the menu item 
brings up a message box that displays the full path of the .cpp file.
...
Name (C++)" menu item in the context menu and a menu seperator below it. 
