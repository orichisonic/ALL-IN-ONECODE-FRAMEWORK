...
<body>
    ...
    <fieldset>
        ...
        <asp:RequiredFieldValidator ID="RequiredValidatorfortbDomainName" ForeColor="Red"
            ...
            Display="Dynamic" ErrorMessage="Please input domain name"></asp:RequiredFieldValidator>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ForeColor="Red" ControlToValidate="tbDomainName"
            runat="server" ValidationGroup="CmdText" Display="Dynamic" ErrorMessage="Please input domain name"></asp:RequiredFieldValidator>
        <br />
        <label>
            UserName:</label>
        <asp:TextBox ID="tbUserName" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredValidatorfortbUserName" ForeColor="Red" ControlToValidate="tbUserName"
            runat="server" Display="Dynamic" ValidationGroup="UploadFile" ErrorMessage="Please input user name"></asp:RequiredFieldValidator>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ForeColor="Red" ControlToValidate="tbUserName"
            runat="server" Display="Dynamic" ValidationGroup="CmdText" ErrorMessage="Please input user name"></asp:RequiredFieldValidator>
        <br />
        <label>
            Password:</label>
        ...
        <asp:RequiredFieldValidator ID="RequiredValidatorfortbPassword" ForeColor="Red" ControlToValidate="tbPassword"
            runat="server" Display="Dynamic" ValidationGroup="UploadFile" ErrorMessage="Please input password"></asp:RequiredFieldValidator>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ForeColor="Red" ControlToValidate="tbPassword"
            runat="server" Display="Dynamic" ValidationGroup="CmdText" ErrorMessage="Please input password"></asp:RequiredFieldValidator>
    </fieldset>
    <div>
        <label>
            Outputs:
