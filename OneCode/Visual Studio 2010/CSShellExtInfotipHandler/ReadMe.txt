...
Install CSShellExtInfotipHandlerSetup(x86).msi, the output of the 
CSShellExtInfotipHandlerSetup(x86) setup project, on a x86 operating 
system. If the target operating system is x64, install 
CSShellExtInfotipHandlerSetup(x64).msi outputted by the 
CSShellExtInfotipHandlerSetup(x64) setup project.

B. Removal

Uninstall CSShellExtInfotipHandlerSetup(x86).msi, the output of the 
CSShellExtInfotipHandlerSetup(x86) setup project, on a x86 operating 
...
Step2. Find a .cs file in the Windows Explorer (e.g. FileInfotipExt.cs in 
...
D. Deploying the infotip handler with a setup project.
  ...
  (1) In CSShellExtInfotipHandler, add an Installer class (named 
  ...
  CSShellExtInfotipHandlerSetup(x86). Click OK to create the project. 
  ...
  In the Add Project Output Group dialog box, CSShellExtInfotipHandler will  
  ...
  CSShellExtInfotipHandler. This adds the custom actions that we defined 
  in ProjectInstaller of CSShellExtInfotipHandler. 
  ...
  Framework version of CSShellExtInfotipHandler. 
  ...
  must create a new setup project (e.g. CSShellExtInfotipHandlerSetup(x64) 
  ...
  file in the CSShellExtInfotipHandlerSetup(x64) project folder. To 
  configure the script to run in the post-build event, you select the 
  CSShellExtInfotipHandlerSetup(x64) project in Solution Explorer, and 
