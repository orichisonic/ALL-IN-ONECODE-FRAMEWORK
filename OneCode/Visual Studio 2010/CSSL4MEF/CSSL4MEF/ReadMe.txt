...
MEF(Managed Extensibility Framework) is a framework which could assist developers
to design extensible application, it's supported by Silverlight 4. This sample utilize
MEF to create a simple text formater. By the predefined contract, user could create
components to enhance the formater's functionality. The components could be loaded
at runtime.
...
To test this sample:
1. Open CSSL4MEF solution and rebuild.
