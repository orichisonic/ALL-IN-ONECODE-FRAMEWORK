===============================================================================
    C# TFS : CSTFSReports Project Overview
===============================================================================

/////////////////////////////////////////////////////////////////////////////
Summary:

There are a lot of reports included in Process Template and they meet out 
most requirement. But sometime we need more data or reports from TfsWarehouse.

This Report Server Project sample works in machines where SQL Server Business
Development Studio 2008 is installed, and SQL Server 2008 Reporting Service is
also required to deploy this report.

The Work Item Age Chart Report demonstrates how to create and deploy a Custom 
Report that can show a chat of work item age range.
...
Step1. Use IE to open a Reports Site of a Team Project(i.e. ProjectA), so the 
site url is like http://<server>/Reports/Pages/Folder.aspx?ItemPath=%2fProjectA
