...
provided by SDK. i.e. inserting an entity to table storage without schema, 
writing a "StorageClient" library in other programming languages, etc. This
sample shows how to generate an HTTP message that uses the List Blobs API. 
You may reuse the code to add authentication header to call other REST APIs.
