...
namespace CodeBoxControl.Decorations
{
  ...
  public  class DecorationSchemes
  {
      public static List<string> lt=new List<string>();
      #region C#
      ...
      public List<string> CSharpReservedWords(string str)
      {
      ...
      public List<string> CSharpVariableReservations()
      {
          return new List<string>() { "string" , "int" , "double", "long"};
      }

      public List<string> CSharpRegions()
      {
