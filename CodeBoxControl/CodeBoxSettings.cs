  ...
  public  class CodeBoxSettings:DependencyObject
    {
        ...
        //#region DecorationCondition
        //public static DependencyProperty DecorationConditionProperty = DependencyProperty.Register("DecorationCondition", typeof(CodeBoxControl.DecorationConditions.DecorationCondition), typeof(CodeBoxSettings),
        //new PropertyMetadata(new CodeBoxControl.DecorationConditions.DecorationCondition(), new PropertyChangedCallback(CodeBoxSettings.OnDecorationChanged)));

        //public CodeBoxControl.DecorationConditions.DecorationCondition DecorationCondition
        //{

        //    get { return (CodeBoxControl.DecorationConditions.DecorationCondition)GetValue(DecorationConditionProperty); }
